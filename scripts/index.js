$(function () {
  ...
  // handles sorting for metadata popup
  function metaSelect() {
    let metaKeys = [];
    mainArr.map((item) => {
  ...
  // create drag and drop funcitonality
    ...
    $(".sortable")
      .sortable({
        ...
        stop: function (event, ui) {
          // reasign todo item a new priority depending on closest banner ↑
          // triggers on drop event and if sorting by priority
        ...
        update: function () {
          // reorders main array to match drag / drop events
          var tempItems = [];
          $(".sortable")
            .children()
            .each(function (i) {
  ...
  // receives commands from main.js
